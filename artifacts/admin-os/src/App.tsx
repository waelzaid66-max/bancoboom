...
function ClerkProviderWithRoutes() {
  ...
  if (!isOfficialDomain) return (
    <div style={{minHeight:'100vh',background:'#000',color:'#fff',display:'flex',alignItems:'center',justifyContent:'center',flexDirection:'column',gap:'1.25rem',fontFamily:'system-ui',textAlign:'center',padding:'2rem'}}>
      ...
      <h1 style={{margin:0,fontSize:'1.6rem',fontWeight:700}}>BANCO Admin Control Center</h1>
      ...
      <a href="https://banco.today/admin-os/" style={{color:'#E8002D',textDecoration:'none',border:'1px solid #E8002D',padding:'0.6rem 1.8rem',borderRadius:'8px',fontSize:'0.95rem'}}>افتح على banco.today ←</a>
    </div>
  );
